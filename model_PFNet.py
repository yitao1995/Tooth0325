...
class Latentfeature(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("\nouts[1] shape: ",outs[1].shape)
        # print("\nouts[2] shape: ",outs[2].shape)
